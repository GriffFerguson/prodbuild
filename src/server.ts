...
/*
 * Arguments:
 * argv[2] action: "start" or "kill" server
 * argv[3] dev/prod: true = start server in output, false = start server in input
 * argv[4] log purge: true means delete current logs
 */
